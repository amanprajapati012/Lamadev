...
const NewPrompt = ({ data }) => {
  ...
  // Ensure that history is well-formed and the first message has a user role
  ...
  const chat = model.startChat({
    history: chatHistory,
    generationConfig: {
      // Optionally set maxOutputTokens here
    },
  });
  ...
  const add = async (text, isInitial) => {
    ...
    try {
      ...
      if (err.message.includes("SAFETY")) {
        setAnswer("Sorry, I couldn't process that request. Please try a different question.");
      } else {
